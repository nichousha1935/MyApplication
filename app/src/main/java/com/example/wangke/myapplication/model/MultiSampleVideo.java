package com.example.wangke.myapplication.model;
...
public class MultiSampleVideo extends StandardGSYVideoPlayer {
    ...
    public void loadCoverImage(String url, int res) {
        mCoverOriginUrl = url;
        mDefaultRes = res;
        Glide.with(getContext().getApplicationContext()).load(url).asBitmap().centerCrop().error(res).placeholder(res).into(mCoverImage);

//package com.example.wangke.myapplication.glide;
//
//
...
//                            .placeholder(R.drawable.home_icon_200_200)
//                            .error(R.drawable.home_icon_200_200)
//                            .into(imageView);
//                }
...
//                            .diskCacheStrategy(DiskCacheStrategy.SOURCE)
//                            .centerCrop()
//                            .placeholder(type == 1 ? R.drawable.home_icon_750_375 : (type == 2 ? R.drawable.home_icon_690_222 : (type == 3 ? R.drawable.home_icon_339_200 : (type == 4 ? R.drawable.home_icon_222_222 : (type == 5 ? R.drawable.home_icon_200_200 : R.drawable.home_icon_750_422)))))
//                            .error(type == 1 ? R.drawable.home_icon_750_375 : (type == 2 ? R.drawable.home_icon_690_222 : (type == 3 ? R.drawable.home_icon_339_200 : (type == 4 ? R.drawable.home_icon_222_222 : (type == 5 ? R.drawable.home_icon_200_200 : R.drawable.home_icon_750_422)))))
//                            .into(imageView);
//                }
//            } else if (context != null) {
//                Glide.with(context).load(url)
...
//            throw new IllegalArgumentException("argument error");
//        }
//        Glide.with(context).load(null == value ? R.drawable.home_icon_200_200 : (value instanceof Integer ? ((Integer) value) : Integer.valueOf((value.toString()))))
//                .diskCacheStrategy(DiskCacheStrategy.SOURCE)
//                .placeholder(type == 3 ? R.drawable.home_icon_200_200 : (type == 2 ? R.drawable.home_icon_650_200 : R.drawable.home_icon_200_200))
//                .error(type == 3 ? R.drawable.home_icon_200_200 : (type == 2 ? R.drawable.home_icon_650_200 : R.drawable.home_icon_200_200))
...
//                .format(DecodeFormat.PREFER_ARGB_8888)
//                .diskCacheStrategy(DiskCacheStrategy.SOURCE)
//                .error(R.drawable.home_icon_750_375)
//                .into(imageView);
//    }
//
//    /**
...
//            throw new IllegalArgumentException("argument error");
//        }
//        Glide.with(imageView.getContext()).load(null == value ? R.drawable.home_icon_200_200 : (value instanceof Integer ? ((Integer) value) : Integer.valueOf((value.toString())))).asBitmap()
//                .format(DecodeFormat.PREFER_ARGB_8888)
//                .diskCacheStrategy(DiskCacheStrategy.SOURCE)
//                .placeholder(R.drawable.home_icon_200_200)
//                .error(R.drawable.home_icon_200_200)
...
//            throw new IllegalArgumentException("argument error");
//        }
//        Glide.with(context).load(null == value ? R.drawable.home_icon_200_200 : (value instanceof Integer ? ((Integer) value) : Integer.valueOf((value.toString())))).bitmapTransform(new BlurTransformation(context, 25)).crossFade(1000).into(imageView);
//
//    }
//
//    /**
